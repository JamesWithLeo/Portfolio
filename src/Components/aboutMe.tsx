  ...
  return (
    <>
      <p className="h-full text-justify indent-8  leading-normal text-darkPrimary text-sm md:leading-loose lg:text-base lg:leading-loose dark:text-white ">
        ...
        keep my mind alive while I feel dead inside. As you can see, my favorite
        color is black—cough*, I implemented dark mode, so click it. Other than
        that, I’m a homebody, meaning I’m not an active person. I’d rather stay
        inside my house scrolling through my phone or playing games.
      </p>
    </>
  );
}
